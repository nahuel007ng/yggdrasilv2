...
4. LOG_STUDY — El usuario registra una sesión de estudio.
...
5. LOG_WORKOUT — El usuario registra un entrenamiento con ejercicios específicos.
...
6. SET_REMINDER — El usuario quiere que le recuerden algo en una fecha.
...
7. QUERY_DATA — El usuario quiere consultar datos registrados.
...
{{
  "action": "ADD_EXPENSE | TOGGLE_HABIT | ADD_TASK | LOG_STUDY | LOG_WORKOUT | SET_REMINDER | QUERY_DATA | UNKNOWN",
  "payload": {{
    "amount": null,
    "description": null,
    "category": null,
